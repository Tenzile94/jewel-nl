    ...
    <div className="container px-4 py-12 md:px-6 md:py-24">
      <div className="flex flex-col items-center justify-center space-y-4 text-center">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Pearls</h1>
      ...
      <div className="grid gap-12 mt-12">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="flex flex-col justify-center space-y-4">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Unlike gemstones formed through geological processes, pearls are created by living organisms. They form
              when an irritant—such as a grain of sand or parasite—enters certain mollusks, particularly oysters and
              mussels. As a defense mechanism, the mollusk secretes layers of nacre (mother-of-pearl) around the
              irritant, eventually forming a pearl.
            </p>
            <p className="text-gray-500 dark:text-gray-400">
              This unique organic origin gives pearls their distinctive luster—an iridescent play of light across the
              surface that seems to glow from within. For thousands of years, this luminous quality has made pearls
              symbols of purity, wisdom, and feminine grace across cultures.
            </p>
            <p className="text-gray-500 dark:text-gray-400">
              While natural pearls were once incredibly rare treasures reserved for royalty, the development of pearl
              cultivation techniques in the early 20th century has made these organic gems more accessible, though no
              less captivating.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-bold mb-6">Natural vs. Cultured Pearls</h2>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">Natural Pearls</h3>
              <p className="text-gray-500 dark:text-gray-400 mb-4">
                Natural pearls form without any human intervention when an irritant accidentally enters a mollusk in the
                wild. The mollusk coats the irritant with nacre, layer upon layer, eventually forming a pearl.
              </p>
              <p className="text-gray-500 dark:text-gray-400">
                Truly natural pearls are extremely rare today. Most pearl-bearing oyster beds have been depleted by
                centuries of harvesting, pollution, and habitat destruction. A natural pearl necklace of matched size
                and color can be more valuable than an equivalent diamond necklace due to this extreme rarity.
              </p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">Cultured Pearls</h3>
              <p className="text-gray-500 dark:text-gray-400 mb-4">
                Cultured pearls are grown with human assistance but are still real pearls. Pearl farmers insert an
                irritant (typically a shell bead nucleus and a piece of mantle tissue) into the mollusk, which then
                forms a pearl sac around it and secretes nacre just as it would in nature.
              </p>
              <p className="text-gray-500 dark:text-gray-400">
                The vast majority of pearls on the market today are cultured. The process was pioneered by Kokichi
                Mikimoto in Japan in the early 1900s, revolutionizing the pearl industry and making these gems more
                widely available.
              </p>
            </div>
          </div>
        ...
        <div className="mt-8">
          ...
          <div className="grid gap-8">
            {pearlTypes.map((type) => (
              <div key={type.name} className="grid gap-6 md:grid-cols-2 items-center">
        ...
        <div className="mt-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {pearlGradingFactors.map((factor) => (
              <div key={factor.name} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
        ...
        <div className="mt-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {pearlShapes.map((shape) => (
              <div key={shape.name} className="border rounded-lg p-4 text-center">
                <div className="relative h-[100px] mx-auto w-[100px] mb-4">
                  <Image src={shape.image || "/placeholder.svg"} alt={shape.name} fill className="object-contain" />
                </div>
                <h3 className="font-bold">{shape.name}</h3>
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">{shape.description}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span>Put pearls on after applying makeup, perfume, and hairspray.</span>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 h-5 w-5 rounded-full bg-green-500 flex items-center justify-center text-white mt-0.5">
                    ✓
                  </div>
                  <span>Wipe pearls with a soft, damp cloth after wearing.</span>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 h-5 w-5 rounded-full bg-green-500 flex items-center justify-center text-white mt-0.5">
                    ✓
                  </div>
                  <span>Store pearls separately from other jewelry to prevent scratching.</span>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 h-5 w-5 rounded-full bg-green-500 flex items-center justify-center text-white mt-0.5">
                    ✓
                  </div>
                  <span>Restring pearl necklaces every few years if worn regularly.</span>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 h-5 w-5 rounded-full bg-green-500 flex items-center justify-center text-white mt-0.5">
                    ✓
                  </div>
                  <span>Wear your pearls regularly—body oils help maintain their luster.</span>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span>Expose pearls to harsh chemicals, including cleaning products.</span>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 h-5 w-5 rounded-full bg-red-500 flex items-center justify-center text-white mt-0.5">
                    ✗
                  </div>
                  <span>Store pearls in plastic bags or airtight containers.</span>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 h-5 w-5 rounded-full bg-red-500 flex items-center justify-center text-white mt-0.5">
                    ✗
                ...
                <li className="flex items-start">
                  ...
                  <span>Wear pearls while swimming, showering, or exercising.</span>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 h-5 w-5 rounded-full bg-red-500 flex items-center justify-center text-white mt-0.5">
                    ✗
                  </div>
                  <span>Leave pearls in direct sunlight for extended periods.</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mt-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {famousPearls.map((pearl) => (
              <div key={pearl.name} className="flex items-start space-x-4 border rounded-lg p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{pearl.description}</p>
                </div>
              </div>
            ))}
          </div>
...
const pearlShapes = [
  {
    name: "Round",
    description: "Perfectly or nearly perfectly spherical; the most classic and typically most valuable shape.",
    image: "/pearl-shape-round.png",
  },
  {
    name: "Near-Round",
    description: "Slightly off-round but still appears round to the casual observer.",
  ...
  {
    name: "Button",
    description: "Flattened on one side, resembling a button; popular for earrings and rings.",
  ...
  {
    name: "Circle",
    description: "Ringed or grooved surface, most common in Tahitian and South Sea varieties.",
    image: "/pearl-shape-circle.png",
  },
  {
    name: "Keshi",
    description: "Small, irregular pearls formed without a nucleus; often very lustrous.",
