    ...
    <div className="container px-4 py-12 md:px-6 md:py-24">
      <div className="flex flex-col items-center justify-center space-y-4 text-center">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Precious Materials</h1>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-12">
        {materials.map((material) => (
          <Card key={material.title} className="overflow-hidden">
            ...
            <CardContent>
              <p className="text-sm text-gray-500 dark:text-gray-400">{material.content}</p>
            </CardContent>
            <CardFooter>
      ...
      <div className="mt-16">
        <h2 className="text-2xl font-bold mb-6">Understanding Precious Metals</h2>
        <div className="grid gap-8 md:grid-cols-2">
          <div>
            <h3 className="text-xl font-bold mb-4">What Makes a Metal Precious?</h3>
            <p className="text-gray-500 dark:text-gray-400">
              Precious metals are rare, naturally occurring metallic elements that have high economic value. They are
              distinguished from base metals by their:
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-start">
                <div className="mr-2 h-2 w-2 rounded-full bg-primary mt-2" />
                <span>
                  <strong>Karats:</strong> Used for gold, with 24 karat being pure gold (99.9%)
                </span>
              </li>
              <li className="flex items-start">
                <div className="mr-2 h-2 w-2 rounded-full bg-primary mt-2" />
                <span>
                  <strong>Fineness:</strong> Expressed in parts per 1,000 (e.g., 925 silver is 92.5% pure)
                </span>
              </li>
              <li className="flex items-start">
                <div className="mr-2 h-2 w-2 rounded-full bg-primary mt-2" />
                <span>
                  <strong>Millesimal fineness:</strong> Similar to fineness but expressed in parts per 1,000
                </span>
              </li>
              <li className="flex items-start">
                <div className="mr-2 h-2 w-2 rounded-full bg-primary mt-2" />
                <span>
                  <strong>Sterling standard:</strong> Specifically for silver, indicating 92.5% purity
                </span>
              </li>
            </ul>
          </div>
      ...
      <div className="mt-16 bg-gray-50 dark:bg-gray-800 p-8 rounded-lg">
        <h2 className="text-2xl font-bold mb-6">Hallmarking: Ensuring Authenticity</h2>
        <p className="text-gray-500 dark:text-gray-400 mb-6">
          Hallmarking is the official marking or series of marks applied to precious metal items to certify their
          purity. The practice dates back to the 14th century and continues to be an important consumer protection
          measure today.
        </p>
