  ...
  return (
    <div className="container max-w-4xl px-4 py-12 md:px-6 md:py-24">
      ...
      <div className="prose prose-gray max-w-none dark:prose-invert">
        ...
        <p>
          Welcome to Jewelry World ("we," "our," or "us"). These Terms of Service ("Terms") govern your access to and
          use of the Jewelry World website, including any content, functionality, and services offered on or through the
          website (the "Service").
        </p>
        <p>
        ...
        <p>
          ...
          thereof) are owned by Jewelry World, its licensors, or other providers of such material and are protected by
          copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.
        </p>
        <p>
          You may access the material on the Service only for your personal, non-commercial use. You must not reproduce,
          distribute, modify, create derivative works of, publicly display, publicly perform, republish, download,
          store, or transmit any of the material on our Service, except as follows:
        </p>
        <ul>
          <li>
        ...
        <p>
          The content provided on Jewelry World is for informational and educational purposes only. While we strive to
          provide accurate and up-to-date information, we make no representations or warranties of any kind, express or
          implied, about the completeness, accuracy, reliability, suitability, or availability of the information,
          products, services, or related graphics contained on the Service for any purpose.
        </p>

        <h2>4. User Contributions</h2>
        <p>
          The Service may contain message boards, chat rooms, personal web pages or profiles, forums, bulletin boards,
        ...
        <ul>
          <li>
            Use the Service in any way that violates any applicable federal, state, local, or international law or
            regulation.
          </li>
          <li>
            Use the Service to engage in any conduct that restricts or inhibits anyone's use or enjoyment of the
            Service.
          </li>
          <li>
            Use the Service to impersonate or attempt to impersonate Jewelry World, a Jewelry World employee, another
            user, or any other person or entity.
          </li>
          <li>
            Engage in any other conduct that restricts or inhibits anyone's use or enjoyment of the Service, or which,
            as determined by us, may harm Jewelry World or users of the Service or expose them to liability.
          </li>
        </ul>
        ...
        <p>
          Your continued use of the Service following the posting of revised Terms means that you accept and agree to
        ...
        <p>
          Questions or comments about the Service or these Terms may be directed to our contact form or by writing to us
