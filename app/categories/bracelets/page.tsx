    ...
    <div className="container px-4 py-12 md:px-6 md:py-24">
      <div className="flex flex-col items-center justify-center space-y-4 text-center">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Bracelets</h1>
          <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
            Discover the variety of bracelets that have adorned wrists throughout history and across cultures.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-12 mt-12">
        {braceletTypes.map((type) => (
          <div key={type.title} className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <Image
              src={type.image || "/placeholder.svg?height=400&width=600&query=elegant bracelet jewelry"}
              alt={type.title}
              width={600}
              height={400}
      ...
      <div className="mt-16">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-800">
                ...
                <th className="border p-2 text-left">Recommended Bracelet Length</th>
        ...
        <p className="mt-4 text-sm text-gray-500">
          Note: Add 1 inch (2.5 cm) to your wrist measurement for a comfortable fit, or 1.5 inches (3.8 cm) for a looser
          fit. For cuff bracelets, your wrist measurement plus 1 inch is typically sufficient.
        </p>
      </div>
    </div>
  )
...
const braceletTypes = [
  {
    ...
    image: "/placeholder.svg?height=400&width=600&query=diamond tennis bracelet",
    features: [
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=600&query=gold bangle bracelets stacked",
    features: [
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=600&query=silver charm bracelet with multiple charms",
    features: [
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=600&query=wide silver cuff bracelet",
    features: [
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=600&query=gold link chain bracelet",
    features: [
...
const braceletSizes = [
  { wrist: "5-5.5 inches (12.7-14 cm)", bracelet: "6-6.5 inches (15.2-16.5 cm)", fit: "Snug" },
  { wrist: "5-5.5 inches (12.7-14 cm)", bracelet: "6.5-7 inches (16.5-17.8 cm)", fit: "Comfort" },
  { wrist: "6-6.5 inches (15.2-16.5 cm)", bracelet: "7-7.5 inches (17.8-19 cm)", fit: "Snug" },
  { wrist: "6-6.5 inches (15.2-16.5 cm)", bracelet: "7.5-8 inches (19-20.3 cm)", fit: "Comfort" },
  { wrist: "7-7.5 inches (17.8-19 cm)", bracelet: "8-8.5 inches (20.3-21.6 cm)", fit: "Snug" },
  { wrist: "7-7.5 inches (17.8-19 cm)", bracelet: "8.5-9 inches (21.6-22.9 cm)", fit: "Comfort" },
]
