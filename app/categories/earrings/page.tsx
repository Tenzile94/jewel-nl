    ...
    <div className="container px-4 py-12 md:px-6 md:py-24">
      <div className="flex flex-col items-center justify-center space-y-4 text-center">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Earrings</h1>
      ...
      <div className="grid gap-12 mt-12">
        {earringTypes.map((type) => (
          <div key={type.title} className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <Image
              src={type.image || "/placeholder.svg?height=400&width=600&query=elegant earring jewelry"}
              alt={type.title}
              width={600}
              height={400}
...
const earringTypes = [
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=600&query=crystal chandelier earrings",
    features: [
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=600&query=silver ear cuff jewelry",
    features: [
...
const earringBacks = [
  ...
  {
    type: "Clip-On Backs",
    description: "Designed for non-pierced ears, these use spring tension to clip onto the earlobe.",
    bestFor: "Those without pierced ears or when wearing earrings for short periods",
  },
  {
