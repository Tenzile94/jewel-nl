  ...
  return (
    <div className="container max-w-4xl px-4 py-12 md:px-6 md:py-24">
      ...
      <div className="prose prose-gray max-w-none dark:prose-invert">
        ...
        <p>
          At Jewelry World, we respect your privacy and are committed to protecting your personal data. This privacy
        ...
        <p>
          ...
          our systems, please contact us using the contact information provided below.
        </p>
        ...
        <h2>7. Contact Us</h2>
        <p>
          If you have any questions about this Privacy Policy, please contact us using the contact information provided
          on our Contact page.
        </p>
